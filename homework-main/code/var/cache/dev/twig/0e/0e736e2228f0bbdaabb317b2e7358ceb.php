...
class __TwigTemplate_44c15d065e29987180cd226e8a4449f0 extends Template
{
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</h1>
                    <p class=\"text-muted\">";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["xMinutes"]) || array_key_exists("xMinutes", $context) ? $context["xMinutes"] : (function () { throw new RuntimeError('Variable "xMinutes" does not exist.', 9, $this->source); })()), "html", null, true);
        echo " minutes</p>
                </div>
        ...
        <div class=\"py-5 bg-light\">
            <div class=\"container\">
                <div class=\"py-5 text-center\">
                    ...
                    <p class=\"text-muted\">{{ xMinutes }} minutes</p>
                </div>
