...
<div class=\"text-muted\">
        ...
        // line 19
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "getUpdatedAt", [], "method", false, false, false, 19), "F j, Y, g:i a"), "html", null, true);
        echo "</small>
            </div>
            ...
            <small class=\"text-muted\">
               ";
        // line 23
        echo twig_escape_filter($this->env, (isset($context["xMinutes"]) || array_key_exists("xMinutes", $context) ? $context["xMinutes"] : (function () { throw new RuntimeError('Variable "xMinutes" does not exist.', 23, $this->source); })()), "html", null, true);
        echo " mins
            </small>
        </div>
    </div>
...
";
    ...
    {
        return array (  84 => 23,  77 => 19,  70 => 15,  66 => 14,  57 => 9,  55 => 8,  49 => 5,  44 => 3,  40 => 1,);
    }
...
<div class=\"text-muted\">
                <small class=\"text-muted\">Last updated:{{ article.getUpdatedAt()|date('F j, Y, g:i a') }}</small>
            </div>
